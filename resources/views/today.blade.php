...
@section('content')
    <div class="col-md-10 py-3">
        <div class="container">
                ...
                <div class="container">
                    ...
                    <div class="card">
                       ...
                       <div class="row"><div class="col-md-8">
                        <table class="table">
                            <div class="theader">
                                PICTURES
                                <a href="#" style="margin-left: 20px" class="btn btn-outline-primary" data-toggle="modal" data-target="#addPictureModal">
                    ...
                    <tbody>
                       <div class="row ext-div" >
                            ...
                            @if ($picture->date==Carbon\Carbon::now('GMT+3')->toDateString())

                            <div class="col-6 " style="padding: 2px;">
                                <div class="int-div">
                                    <img src="http://192.168.43.114:8000/api/picture/file/{{$picture->id}}" alt="Picture" style="width: 100%;padding:5px">
                                    <div class="row" style="padding: 5px">
                                        <div class="col-md-7">
                                            <h5>Date: <span style="color: rgb(16, 22, 105);font-weight:bolder">{{$picture->date}}</span></h4>
                                            </div>
                        ...
                        @endif
                           ...
                           <div class="col-md-4">
                               <table class="table">
                                   <div class="theader">
                                       VIDEOS
                                       <a href="#" style="margin-left: 20px" class="btn btn-outline-primary" data-toggle="modal" data-target="#addVideoModal">
                                        <i class="fas fa-plus"></i> Add
                                    </a>
                                   </div>
                            <tbody>
                               <div class="row ext-div" >
                                    ...
                                    @if ($video->date==Carbon\Carbon::now('GMT+3')->toDateString())
            ...
            <!-- ADD PICTURE MODAL -->
            <div class="modal fade" id="addPictureModal">
